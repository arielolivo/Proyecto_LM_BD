...
<a href="index.php" class="btn btn-success" tabindex="-1" role="button" aria-disabled="true">RETROCEDER</a>
</div>
...
<div style="background: #29CB5B; border-radius: 5px 5px 5px 5px"><h3>SENSORES</h3></div>
...
PONER REFRESCO PÁGINA. HECHO
PONER PANEL SPOILER INFORMACIÓN.
PONER EJEMPLOS DE TEXTO (placeholder).
