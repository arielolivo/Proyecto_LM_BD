...
print "<div style='width:83.7%;float:left;margin-left:1px;margin-right:1px'>";
    ...
    $limite = $inicio*6;
        ...
        $objBd->consultarBD("SELECT m.Fecha_Hora,s.modelo,m.Valor,s.id,m.Sensores_id,m.Variables_Id FROM medidas m inner join sensores s on m.Sensores_id = s.id ORDER BY Fecha_Hora LIMIT $limite,6");
